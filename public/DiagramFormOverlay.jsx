...
export function DiagramFormOverlay({
  imageSrc,
  imageAlt,
  aspectRatio,     // e.g. "760 / 780" — width / height of the source image
  maxWidth = 720,
  fields,           // [{ id, top, left, align, ...whatever your renderField needs }]
  renderField,      // (field, ref) => JSX — you control what renders at each point
}) {
  return (
    <div
      style={{
...
export function CheckboxField({ field, checked, onChange }) {
  return (
    <>
      <input
        type="checkbox"
        ...
        style={{ width: "clamp(12px, 2.2vw, 18px)", height: "clamp(12px, 2.2vw, 18px)", flexShrink: 0, cursor: "pointer" }}
      />
      <label
        htmlFor={field.id}
  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 }}>
        <h2 style={{ fontSize: 16, fontWeight: 600, margin: 0 }}>2.7 Assessment of muscular function</h2>
      ...
      <DiagramFormOverlay
        imageSrc="/images/muscle-assessment-diagram.png" // <- swap for your real asset path
      ...
      <pre style={{ fontSize: 11, background: "#fafafa", padding: 12, borderRadius: 6, marginTop: 16, overflowX: "auto" }}>
